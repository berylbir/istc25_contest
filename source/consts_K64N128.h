#ifndef CONSTS_K64N128_H
#define CONSTS_K64N128_H
...
inline constexpr int N = 128;                  /* Number of output bits */
inline constexpr int V = 8;                    /* Number of memory elements */
inline constexpr int M = 12;                   /* Degree of CRC - 1 */
inline constexpr unsigned int CRC = 0x1565;    /* CRC polynomial */
inline const std::vector<int> numerators = {561, 753};  /* in octal */

inline constexpr int NUM_INFO_BITS = 64;       /* Number of information bits */
inline constexpr int NUM_CODED_SYMBOLS = 128;  /* Number of coded symbols */
inline constexpr int numPairs = 1 << (M + V);  /* Number of syndromes */
/* range of offsets in squared Euclidean distance */
inline constexpr int lowDist = 4;  
inline constexpr int highDist = 48;  // hamming distance 12

inline const std::vector<int> PUNCTURING_INDICES = {4, 10, 21, 24, 31, 37, 42, 48, 59, 62, 69, 75, 80, 86, 97, 100, 107, 113, 118, 124, 135, 138, 145, 151};   /* 2023 ISTC paper puncturing pattern */

/* --- List Decoder Parameters --- */
inline constexpr int MAX_LISTSIZE = 8192;       /* Maximum list size */
